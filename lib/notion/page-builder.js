...
//
// transcriptUpload 는 { id, charCount } 형태. null/undefined면 진단 토글
// 안의 file block 만 생략되고 나머지 근거 인용 섹션은 그대로 생성된다.
...
export function buildMeetingPageBlocks(data, transcriptUpload = null) {
  const blocks = [];
...
export function buildEvidenceBlocks(data, transcriptUpload = null) {
