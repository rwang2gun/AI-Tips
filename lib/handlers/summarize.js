...
// 요약/제목 압축용 모델. 2026-06 Gemini 2.x 정리로 2.5-pro에서 3.1-pro로 이관
// (3.5-pro는 미출시). 긴 transcript + responseSchema 안정성 위해 flash가 아닌 pro 유지.
const SUMMARIZE_MODEL = 'gemini-3.1-pro';
