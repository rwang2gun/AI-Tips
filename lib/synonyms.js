...
// Phase B에서 NotionClient 주입 + applySynonymReplacements 를 lib/transcript/post-process.js 로 분리 예정.
//
// @notionhq/client는 동적 import — 순수 힌트 빌더(buildTranscribeSynonymHint 등)는
